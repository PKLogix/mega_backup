...
app_name = "mega_backup"
app_title = "Mega Backup"
app_publisher = "PKLogix.com"
app_description = "Use Mega Backup for Frappe and ERPNext"
app_icon = "octicon octicon-cloud-upload"
app_color = "#ff0000"
app_email = "pklogix.official@gmail.com"
app_version = "0.0.1"
app_license = "MIT"
...
scheduler_events = {
    "daily_long": [
        "mega_backup.task.take_backups_daily"
    ],
    "weekly_long": [
        "mega_backup.task.take_backups_weekly"
    ],
    "monthly_long": [
        "mega_backup.task.take_backups_monthly"
    ]
}
...
# before_tests = "mega_backup.install.before_tests"

# Overriding Whitelisted Methods
# ------------------------------
#
# override_whitelisted_methods = {
# 	"frappe.desk.doctype.event.event.get_events": "mega_backup.event.get_events"
# }
